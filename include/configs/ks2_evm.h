...
/* SGMII SerDes */
#define CONFIG_KSSERDES_SGMII_BASE	KS2_SGMII_SERDES_BASE
#define CONFIG_KSSERDES_LANES_PER_SGMII	KS2_LANES_PER_SGMII_SERDES
#define CONFIG_KSSERDES_SGMII2_BASE	KS2_SGMII_SERDES2_BASE
