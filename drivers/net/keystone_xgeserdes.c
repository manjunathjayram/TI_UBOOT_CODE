...
#define xgeserdes_dbg			0
#define pr_debug(fmt, args...)		if (xgeserdes_dbg) printf(fmt, ##args)
...
u32 xge_serdes_initialized;
u32 xge_link_retries;

struct hw_specific this_hw = {
	.ref_clock_rate = K2SERDES_REF_CLOCK_156P25M,
	.link_rate = K2SERDES_LINK_RATE_10P3125G,
	.lanes = 2,
	.phy_type = K2SERDES_PHY_XGE,
	.c1 = 2,
	.c2 = 0,
	.cm = 2,
	.tx_att = 12,
...
static inline u32 k2serdes_readl(u32 base, u32 offset)
{
	return readl(base + offset);
}

static inline void k2serdes_writel(u32 base, u32 offset, u32 value)
{
	writel(value, base + offset);
}

static inline u32 k2serdes_read_tbus_val(u32 serdes)
{
	u32 tmp;
...
static void k2serdes_write_tbus_addr(u32 serdes, int select, int ofs)
{
...
u32 k2serdes_read_select_tbus(u32 serdes, int select, int ofs)
{
	/* set tbus address */
...
static inline void k2serdes_config_ss(u32 ss_base,
...
static inline void k2serdes_phyb_rst_clr(u32 serdes)
{
	FINSR(serdes, CML_REG(0), 5, 0, 0x1f);
}

static inline int k2serdes_phyb_in_rst(u32 serdes)
{
	u32 val;
...
static inline void k2serdes_pll_disable(u32 serdes)
{
	FINSR(serdes, PLL_CTRL_REG, 31, 29, 0x4);
	FINSR(serdes, PLL_CTRL_REG, 27, 25, 0x4);
}

static inline void k2serdes_pll_enable_10p3125g(u32 serdes)
{
	FINSR(serdes, PLL_CTRL_REG, 31, 29, 0x7);
	FINSR(serdes, PLL_CTRL_REG, 27, 25, 0x7);
}

static inline void k2serdes_pll_enable_1p25g(u32 serdes)
{
	k2serdes_writel(serdes, PLL_CTRL_REG, 0xe0000000);
}

static inline void k2serdes_pll_enable(u32 serdes, struct hw_specific *hw)
{
...
static int k2serdes_init(u32 serdes, struct hw_specific *hw)
{
	struct serdes_cfg *serdes_cfg;
	u32 base;
	int a_size;
...
/* lane is 0 based */
static inline void k2serdes_lane_10p3125g_config(u32 serdes, int lane)
{
	struct serdes_cfg *serdes_cfg;
	u32 base;
	int a_size;
...
static inline void k2serdes_lane_1p25g_config(u32 serdes, int lane)
{
	struct serdes_cfg *serdes_cfg;
	u32 base;
	int a_size;
...
static inline void k2serdes_lane_config(u32 serdes, int lane,
...
static inline void k2serdes_com_enable(u32 serdes, struct hw_specific *hw)
{
	struct serdes_cfg *serdes_cfg;
	u32 base;
	int a_size;
...
static inline void k2serdes_eq_vreg_enable(u32 serdes, struct hw_specific *hw)
{
	u32 i;
...
static inline void k2serdes_eq_cdfe_enable(u32 serdes, struct hw_specific *hw)
{
	u32 i;
...
static void k2serdes_tx_rx_set_equalizer(u32 serdes, struct hw_specific *hw)
{
	u32 i;
...
static inline void k2serdes_lane_enable(u32 serdes, int lane,
					struct hw_specific *hw)
{
...
static inline int k2serdes_get_lane_status(u32 serdes,
...
static int k2serdes_get_status(u32 serdes, struct hw_specific *hw)
{
	u32 lanes_ok = 1;
	int i;
...
static int k2serdes_wait_pll_locked(u32 serdes, struct hw_specific *hw)
{
...
static void k2serdes_assert_reset(u32 serdes, struct hw_specific *hw)
{
	u32 i;
...
static inline void k2serdes_deassert_reset_poll_xge(u32 serdes,
						struct hw_specific *hw)
{
...
static inline void k2serdes_deassert_reset_poll_pcie(u32 serdes,
						struct hw_specific *hw)
{
	u32 tmp, i;
...
static inline void k2serdes_deassert_reset_poll_others(u32 serdes,
						struct hw_specific *hw)
{
	u32 lanes_ok = MASK((hw->lanes - 1), 0);
	u32 val;
...
static int k2serdes_deassert_reset(u32 serdes, struct hw_specific *hw, int poll)
{
	u32 i;
...
/* lane is 0-based */
static void k2serdes_get_cmp_tap_offsets_xge(u32 serdes,
...
static void k2serdes_add_offsets_xge(u32 serdes,
...
/* lane is 0-based */
static void k2serdes_get_cmp_tap_offsets_non_xge(u32 serdes,
	u32 lane, u32 cmp, struct k2serdes_comparator_tap_offsets *ofs)
{
	/* set comparator number */
	FINSR(serdes, CML_REG(0x8c), 23, 21, cmp);
...
static void k2serdes_add_offsets_non_xge(u32 serdes,
	struct hw_specific *hw, struct k2serdes_offsets *sofs)
{
	struct k2serdes_comparator_tap_offsets *ctofs;
	struct k2serdes_comparator_tap_offsets sample;
...
static void k2serdes_get_average_offsets(u32 serdes, u32 samples,
		struct hw_specific *hw, struct k2serdes_offsets *sofs)
{
	struct k2serdes_comparator_tap_offsets *ctofs;
	struct k2serdes_lane_offsets *lofs;
...
static void k2serdes_override_cmp_tap_offsets(u32 serdes,
	u32 lane, u32 cmp, struct k2serdes_comparator_tap_offsets *ofs)
{
...
static inline void k2serdes_override_cmp_offset_cdfe(u32 serdes,
...
static inline void k2serdes_override_tap_offset_cdfe(u32 serdes,
...
static void k2serdes_override_cmp_tap_offsets_cdfe(u32 serdes,
	u32 lane, u32 cmp, struct k2serdes_comparator_tap_offsets *ofs)
{
	/* enable overrides */
...
static void k2serdes_set_offsets_xge(u32 serdes,
	struct hw_specific *hw, struct k2serdes_offsets *sofs)
{
	struct k2serdes_comparator_tap_offsets *ctofs;
	struct k2serdes_lane_offsets *lofs;
...
static void k2serdes_set_offsets_non_xge(u32 serdes,
	struct hw_specific *hw, struct k2serdes_offsets *sofs)
{
	struct k2serdes_comparator_tap_offsets *ctofs;
	struct k2serdes_lane_offsets *lofs;
...
static void k2serdes_set_offsets(u32 serdes,
	struct hw_specific *hw, struct k2serdes_offsets *sofs)
{
	if (hw->phy_type == K2SERDES_PHY_XGE)
...
static inline void k2serdes_config_c1_c2_cm(u32 serdes,
...
static void k2serdes_dfe_offset_calibrate(u32 serdes,
					struct hw_specific *hw)
{
...
static inline void k2serdes_enable_xgmii_port(u32 sw_regs)
{
	k2serdes_writel(sw_regs, XGE_CTRL_OFFSET, 0x03);
}

void k2serdes_reset_cdr(u32 serdes, int lane)
{
...
/* Call every 10 ms */
int k2serdes_check_link_status(u32 serdes,
			      u32 sw_regs,
			      u32 lanes,
			      u32 *current_state,
			      u32 *lane_down)
...
static int k2serdes_check_lane(u32 serdes, u32 sw_regs, u32 lanes)
{
...
static inline void k2serdes_reset(u32 serdes)
{
	/* Toggle POR_EN bit */
...
static inline void k2serdes_txb_clk_mode(u32 serdes, struct hw_specific *hw)
{
...
static int k2serdes_config(u32 serdes, u32 sw_regs, struct hw_specific *hw)
{
...
{
	u32 serdes, xge_sw_regs;
	int ret;

	serdes = XGE_SERDES_BASE;
	xge_sw_regs = XGE_SW_BASE;

	pr_debug("XGE: serdes reset\n");
...
{
	int ret;
	struct hw_specific *hw = &this_hw;

	if (xge_serdes_initialized)
		return 0;

	ret = k2serdes_start(hw);
	if (!ret)
		++xge_serdes_initialized;
