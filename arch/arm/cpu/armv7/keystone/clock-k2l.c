...
static const struct pll_regs pll_regs[] = {
	[CORE_PLL]	= { K2L_MAINPLLCTL0, K2L_MAINPLLCTL1},
	[PASS_PLL]	= { K2L_PASSPLLCTL0, K2L_PASSPLLCTL1},
	[TETRIS_PLL]	= { K2L_ARMPLLCTL0,  K2L_ARMPLLCTL1},
	[DDR3_PLL]	= { K2L_DDR3PLLCTL0, K2L_DDR3PLLCTL1},
};
...
static unsigned long pll_freq_get(int pll)
{
	...
	if (pll == CORE_PLL) {
		...
		if (pllctl_reg_read(pll, ctl) & PLLCTL_PLLEN) {
			/* PLL mode */
			tmp = __raw_readl(K2L_MAINPLLCTL0);
			prediv = (tmp & 0x3f) + 1;
